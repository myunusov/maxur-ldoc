...
import org.maxur.ldoc.annotation.Links;
...
public class SubDomain {
     ...
     * @return the optional
     */
    static Optional<SubDomain> makeBy(final PackageDoc aPackage) {
        ...
        switch (types.size()) {
            ...
            case 1: return Optional.of(new SubDomain(aPackage, types.get(0)));
            default:
